                            ...
                            <div className="row">
                                ...
                                <div className="">
                                    <div className='container-p-y'>
                                        ...
                                        <div className="">
                                            <div className="card">
                                                <h5 className="card-header">Account Wise List</h5>
                                                        ...
                                                        <tbody className="table-border-bottom-0">
                                                            ...
                                                            {uniqueData.map((item, i) =>
                                                                ...
                                                                <tr key={i}>
                                                                    ...
                                                                    <td>
                                                                        <span className='text-primary'><Link to={'/admin/summary-sender-report/'+item.username}>{item.username} </Link> </span>
                                                                    </td>

                                                                    <td> <Link to={'/admin/summary-sender-report/'+item.username}><span className='text-primary'> {parseInt(item.count.delivered) + parseInt(item.count.failed) + parseInt(item.count.other)} </span> </Link> </td>
                                                                    <td>
                                                                    <Link to={'/admin/summary-sender-report/'+item.username}><span className='text-success'> {item.count.delivered || 0} </span></Link>
                                                                    </td>
                                                                    <td>
                                                                    <Link to={'/admin/summary-sender-report/'+item.username}><span className='text-danger'> {item.count.failed || 0} </span></Link>
                                                                    </td>
                                                                    <td>
                                                                        <span className='badge bg-primary mr-2'> <Link to={'/admin/summary-sender-report/'+item.username}> View </Link> </span>
                                                                    </td>
...
export default NewSummaryReport;